...
a = 10; // перемеменные раньше уже были объявлены, меняю их значение
b = 2; // перемеменные раньше уже были объявлены, меняю их значение
c = 5; // перемеменные раньше уже были объявлены, меняю их значение
...
a = 17; // перемеменные раньше уже были объявлены, меняю их значение
b = 10; // перемеменные раньше уже были объявлены, меняю их значение
c = a - b;
d = 7; 
result = c + d;
